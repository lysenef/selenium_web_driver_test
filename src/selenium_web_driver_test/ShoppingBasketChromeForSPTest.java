...
public class ShoppingBasketChromeForSPTest extends BaseTest {
	...
	public static void setUpBeforeClass(){
		...
		if(driver == null){
			...
			options.addArguments("--user-agent=Mozilla/5.0 (iPhone; CPU iPhone OS 6_0 like Mac OS X) "
	...
	public void test() throws InterruptedException {
		...
		givenShopperGoesOnShoppingBasketForSP(wait, driver);
		// Shopping basket
